...
import { hybridReturn } from '../src/utils/misc.js'
...
import type { RawLayerCacheXOptions } from '../src/types/options/options.js'
...
export class CacheFactory {
  #parameters: Partial<RawLayerCacheXOptions & CacheStackDrivers> = {}
   ...
   */
  merge(parameters: Partial<RawLayerCacheXOptions & CacheStackDrivers>) {
