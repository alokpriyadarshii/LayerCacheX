 ...
 * the LayerCacheX options. Setting them specifically
 * for a driver will override the LayerCacheX options.
 */
...
export type MemoryConfig = {
   ...
   *
   * @see http://layercachex.dev/docs/cache-drivers#serialize-option
   * @default true
   */
  serialize?: boolean
} & DriverCommonOptions
