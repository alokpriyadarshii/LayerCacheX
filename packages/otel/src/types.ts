...
export type LayerCacheXModuleExports = {
  LayerCacheX?: new (...args: any[]) => any
  tracingChannels?: {
...
export interface LayerCacheXInstrumentationConfig extends InstrumentationConfig {
  /**
  ...
  /**
   * Suppress internal LayerCacheX operations (L2 + bus)
   * @default true
   */
